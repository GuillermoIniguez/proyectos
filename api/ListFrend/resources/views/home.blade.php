        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="#servicios">TEXTO</a></li>
                    <li><a class="dropdown-item" href="#reparaciones">TEXTO</a></li>
                    <li><a class="dropdown-item" href="#modificaciones">TEXTO</a></li>
                </ul>
            </li>
        <li class="nav-item">
...
<div class="carousel-inner">             
        <div class="carousel-item active">                
            <div class="d-flex justify-content-between">                     
                <img src="{{ asset('image/amigos.jpg') }}" class="custom-image" alt="Imagen 1">
                <img src="{{ asset('image/amigos2.jpg') }}" class="custom-image" alt="Imagen 2">
                <img src="{{ asset('image/amigos3.jpg') }}" class="custom-image" alt="Imagen 3">
            </div>            
        </div>             
        <div class="carousel-item">                 
            <div class="d-flex justify-content-between">                     
                <img src="{{ asset('image/amigos4.jpg') }}" class="custom-image" alt="Imagen 4">
                <img src="{{ asset('image/amigos5.jpg') }}" class="custom-image" alt="Imagen 5">
                <img src="{{ asset('image/amigos6.jpg') }}" class="custom-image" alt="Imagen 6"> 
            </div>
        </div>
    </div>
...
<header class="jumbotron text-center" style="font-family: 'Montserrat', sans-serif;">
    <h1 class="display-4">ListFrend</h1>
    {{-- <p class="lead">Haz relaciones solidas con tus mismos intereses</p>
...
<div id="carouselExample1" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <div class="image-container">
                <img src="{{ asset('image/amigos8.jpg') }}" class="d-block w-100" alt="Imagen 4">
            </div>
            <div class="text-container">
                <h5>Reparaciones</h5>
                <p>• 
        ...
        <div class="carousel-item">
            <div class="image-container">
                <img src="{{ asset('image/amigos9.jpg') }}" class="d-block w-100" alt="Imagen 4">
            </div>
            <div class="text-container">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <div class="image-container2">
                <img src="{{ asset('image/amigos10.jpg') }}" class="d-block w-100" alt="Imagen 1">
            </div>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <div class="image-container3">
                <img src="{{ asset('image/amigos11.jpg') }}" class="d-block w-100" alt="Imagen 1">
            </div>
...
<section id="modificaciones" class="container-fluid section-container">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <div class="image-container2">
                <img src="{{ asset('image/amigos12.jpg') }}" class="d-block w-100" alt="Imagen 1">
            </div>
            <div class="text-container2">
                <h5>Modificaciones</h5>
                <div class="scrollable-list">
...
<div id="contacto" class="main-container">
    ...
    <div class="right-half">
        ...
        <a href="https://play.google.com/store/games?hl=en&gl=US&pli=1">
            <div class="app-logo">
                <img src="{{ asset('image/LOGO.png') }}" alt="Logo de la App" width="200" height="200">
            </div>
        </a>
    </div>
</div>
...
<footer class="text-center p-4 text-white" style="background-color: #212529">
    <p>© [2024] Derechos de autor. Desarrollado por 
        <a href="https://www.instagram.com/guille_iniguez/" 
        style="color: #27d7f7;">[Guillermo Iñiguez]</a>. Todos los derechos reservados. </p>
</footer>
@endsection 
